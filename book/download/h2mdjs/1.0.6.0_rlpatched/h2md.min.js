...
*/
var e;
function p(){this.C=-1;this.a={};this.a.width=0;this.a.height=0;this.a.L=0;this.a.K=0;this.a.frames=0;this.a.Ma=0;this.a.Ha=0;this.a.I=0;this.a.X=1;this.a.O=1;this.H=this.g=this.a.w=0;this.$=[];this.Z=[];this.v=this.B=this.s=this.f=null;this.b=new aa;this.o=new ba;this.A=0;this.C=-1;this.G=this.m=null;this.Fa={};this.Ea={};this.ta={};this.c={};this.c.ia=null;this.c.ha=null;this.c.buffered=null;this.c.done=null;this.c.request=null;this.c.P=null;this.fa=!1;this.ea="";this.na=this.ma=!1;this.aa=this.ba=
this.da=this.ca=0;this.ka=null;this.l=this.oa=this.u=0;this.F=-1;this.i=0;this.T=[];this.R=this.S=this.U=this.D=0;this.Ga="anonymous"}var q=[];function t(a,b){var c=a.split("/"),c=c[c.length-1];q[c]=b;c=document.createElement("script");c.type="text/javascript";c.src=a;document.body.appendChild(c)}
...
f.send(null)}}}function ia(a,b,c){return a.c.request?b:b+c}function ja(a,b,c,d,f,h){c[d]=new Image;c[d].crossOrigin=a.Ga;c[d].onload=h;c[d].onerror=function(){P(b,"i picture image not found")};c[d].src=f}
...
null;a.a.w&16?a.c.request?a.c.request(f,h):h(f):c?ga(a):A(a)})};a.c.request?a.c.request(d,u):u(d)}}e=p.prototype;e.wa=function(a){this.c.ha=a};e.done=function(a){this.c.done=a};e.buffered=function(a){this.c.buffered=a};e.request=function(a){this.c.request=a};e.P=function(a){this.c.P=a};e.open=function(a,b){this.G?P(this,"new instance require"):(this.G=a,this.c.ia=b,A(this))};e.ua=function(a){a=document.getElementById(a);if(!a)return!1;this.B=a;this.v=null;this.la&&ca(this);return!0};
e.Da=function(a,b,c,d){this.na=!0;this.ca=a;this.da=b;this.ba=c;this.aa=d};e.ya=function(a){if(void 0===a||-1>a)return!1;this.C=a;return!0};e.za=function(){return la(this)};function la(a){if(a.m||-1>a.C||a.C>=a.a.frames||!a.B)return!1;requestAnimationFrame?(a.m=!0,a.R=(new Date).getTime(),requestAnimationFrame(function(){na(a)})):a.m=setInterval(function(){qa(a)},1E3/a.a.I);return!0}
function na(a){if(a.m){for(var b=(new Date).getTime(),c=1E3/a.a.I,d=Math.ceil(a.a.I/60);b-a.R>=c;)1<=d&&qa(a),a.R+=c,d--;requestAnimationFrame(function(){na(a)})}}e.ra=function(){return null!=this.m};e.Ca=function(a){if(void 0===a||0>a||a>=this.a.frames)return!1;this.A=a;return!0};e.Y=function(){this.ja();this.A=0};e.ja=function(){this.m&&("number"===typeof this.m&&clearInterval(this.m),this.m=null)};e.Ba=function(a){this.fa=a};
e.xa=function(){if(0==this.a.frames)return null;var a={};a.width=this.a.width;a.height=this.a.height;a.fps=this.a.I;a.frames=this.a.frames;a.version=this.a.version;return a};e.Aa=function(){if(0==this.a.frames)return null;var a={};a.frames=this.a.frames;a.current_frame=this.S;a.buffered_frame=this.D;return a};e.Ia=function(a){this.ka=a};e.va=function(a){return this.ga(a,0,0,this.a.width,this.a.height,0,0,this.a.width,this.a.height)};
e.ga=function(a,b,c,d,f,h,u,v,m){if(void 0===a||0>a||a>=this.a.frames)return null;try{this.S=a;var k=a-(this.f.frame-1);if(!(0<=k&&k<=this.f.M)&&1!=k){var l=0,g=this.ta;g.h=0;for(g.j=this.a.J;;){var w=g.j,y=Y(this,g);if(a<l+y.frames){this.f.frame=l;this.f.M=0;this.f.j=w;this.f.h=g.h;break}g.j=w+y.sa;g.h=g.h+y.W;l+=y.frames}k=a-(this.f.frame-1)}for(l=0;l<k;l++){var ka=this.f.frame%2,ya=(this.f.frame+1)%2,x=sa(this.f),C=this.f.M;0==C&&(C=Y(this,x).frames);if(!this.la){var r=this.o,ma=this.B;r.f=Array(3);
...
V),L.drawImage(M,b,c,d,f,h,u,v,m),L.globalCompositeOperation="source-over");ra=M;return ra}catch(W){if("reload"==W)return this.F=this.o.G,null;if("loading"==W)return null;this.Y();P(this,W)}};e.La=function(a){this.ea=a?"?"+(new Date).getTime():""};e.Ka=function(a){this.ma=a};e.Na=function(a){this.l=a?60:0};window.H2MD=p;p.prototype.open=p.prototype.open;p.prototype.play=p.prototype.za;p.prototype.seek=p.prototype.Ca;p.prototype.playing=p.prototype.ra;p.prototype.stop=p.prototype.Y;
p.prototype.pause=p.prototype.ja;p.prototype.error=p.prototype.wa;p.prototype.done=p.prototype.done;p.prototype.buffered=p.prototype.buffered;p.prototype.info=p.prototype.xa;p.prototype.position=p.prototype.Aa;p.prototype.decode=p.prototype.va;p.prototype.canvas=p.prototype.ua;p.prototype.stretch=p.prototype.Da;p.prototype.loop=p.prototype.ya;p.prototype.nonce_url=p.prototype.La;p.prototype.jsonp=p.prototype.Ka;p.prototype.streaming=p.prototype.Na;p.prototype.timeupdate=p.prototype.P;
p.prototype.request=p.prototype.request;p.prototype.composite=p.prototype.ga;p.prototype.composite_operation=p.prototype.Ia;p.prototype.profile=p.prototype.Ba;p.jsonpRequest=t;p.jsonpCallback=function(a){for(key in a)q[key](a[key])};function da(a,b){return Math.floor((a+b-1)/b)*b}function ea(a){var b={frame:0,h:0,M:0};b.j=a.a.J;return b}
function qa(a){if(a.fa){var b=[];b.push((new Date).getTime())}a.ga(a.A,0,0,a.a.width,a.a.height,a.ca,a.da,a.ba,a.aa)&&(a.A++,a.A>=a.a.frames&&(-1!=a.C?a.A=a.C:(a.A=0,a.Y(),a.c.done&&a.c.done())),a.fa&&(b.push((new Date).getTime()),b=""+(""+(b[1]-b[0])+"[msec]"),a.v.fillStyle="white",a.v.fillText(b,2,10)),a.c.P&&a.c.P())}function Y(a,b){var c=N(a.b,b),d=N(a.b,b);N(a.b,b);if(71!=c||72!=d)throw"gop header broken";c=a.Ea;c.frames=O(a.b,b);c.sa=O(a.b,b);c.W=O(a.b,b);return c}
function ua(a,b){var c=N(a.b,b),d=N(a.b,b);N(a.b,b);if(71!=c||84!=d)throw"gop tailer broken";c=a.Fa;c.frames=O(a.b,b);c.sa=O(a.b,b);c.W=O(a.b,b)}function sa(a){var b={};b.j=a.j;b.h=a.h;return b}function fa(a){for(;a.s.frame<a.a.frames;)try{var b=sa(a.s),c=a.s.M;0==c&&(c=Y(a,b).frames);var d=b,f=ta(a.o,d);d.h+=f.W;d.j+=f.pa-f.J;c--;0==c&&ua(a,b);var h=a.s,d=b;h.M=c;h.j=d.j;h.h=d.h;h.frame++}catch(u){break}b=a.o;a.oa=Math.floor((a.s.h+b.l*b.u-1)/b.l/b.u)}function aa(){this.a=null;this.c=this.b=0}
...
function ta(a,b){var c=N(a.c,b);if(70!=c)throw"frame header broken "+c;c=a.H;c.qa=N(a.c,b);c.Oa=N(a.c,b);c.J=O(a.c,b);c.pa=O(a.c,b);c.W=O(a.c,b);for(var d=12;d<c.J;d+=3)O(a.c,b);return c}
